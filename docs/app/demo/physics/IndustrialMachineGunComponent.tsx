...
const IndustrialMachineGunComponent: Component<IndustrialMachineGunProperties> = {
    ...
    properties: {
        ...
        fireRate: { default: DEFAULT_FIRE_RATE },
        projectileSpeed: { default: DEFAULT_PROJECTILE_SPEED },
        projectileRadius: { default: DEFAULT_PROJECTILE_RADIUS },
        projectileLifetime: { default: DEFAULT_PROJECTILE_LIFETIME },
        muzzleOffset: { default: DEFAULT_MUZZLE_OFFSET },
        muzzleFlashId: { type: "string", default: "" },
        spread: { default: DEFAULT_SPREAD },
        shotEventName: { type: "string", default: DEFAULT_SHOT_EVENT },
        triggerEventName: { type: "string", default: DEFAULT_TRIGGER_EVENT },
        projectileCountEventName: { type: "string", default: DEFAULT_PROJECTILE_COUNT_EVENT },
        aimYawRange: { default: DEFAULT_YAW_RANGE },
        aimPitchRange: { default: DEFAULT_PITCH_RANGE },
        aimSmoothing: { default: DEFAULT_AIM_SMOOTHING },
        recoilKick: { default: DEFAULT_RECOIL_KICK },
        recoilReturn: { default: DEFAULT_RECOIL_RETURN },
        fireSound: { type: "string", default: "/sound/explode.mp3" },
        fireVolume: { default: DEFAULT_FIRE_VOLUME },
    },
};
